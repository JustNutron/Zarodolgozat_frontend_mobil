...
export default class Memoria extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      ...
      <View style={styles.hatter}>
        ...
        {isLoading ? <ActivityIndicator/> : (
          <FlatList
            data={data}
            keyExtractor={({ memoria_id}, index) => memoria_id}
            renderItem={({ item }) => (
              ...
              <View style={{flex:2}}>
              <Image   source={{uri: IP.ipcim+item.memoria_kep+'.png'}} style={styles.kep}   />
              </View> 
              ...
              <Text style={styles.adatok}>
                Órajel: 
                {item.memoria_orajel} Mhz
              </Text>
              <Text style={styles.adatok}>
                Kapacitás: 
                 {item.memoria_kapacitas} GB
              </Text>
              </View>
              </View>    
              </View>
